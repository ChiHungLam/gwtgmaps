...
public class GIcon extends JavaScriptObject
{
	...
	{
		return (GSize)JavaScriptObjectHelper.getAttributeAsJavaScriptObject(this, "iconSize");
	}
	...
	{
		return (GSize)JavaScriptObjectHelper.getAttributeAsJavaScriptObject(this, "shadowSize");
	}
	...
	{
		return (GPoint)JavaScriptObjectHelper.getAttributeAsJavaScriptObject(this, "iconAnchor");
	}
	...
	{
		return (GPoint)JavaScriptObjectHelper.getAttributeAsJavaScriptObject(this, "infoWindowAnchor");
	}
