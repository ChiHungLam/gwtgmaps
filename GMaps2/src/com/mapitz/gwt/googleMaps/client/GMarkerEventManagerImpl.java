...
class GMarkerEventManagerImpl
{
	 ...
	 */
	public static native void addOnClickListener(GMarkerEventManager manager, GMarker source)/*-{		
	 ...
	 */
	public static native void addOnDragStartListener(GMarkerEventManager manager, GMarker source)/*-{		
	 ...
	 */
	public static native void addOnDragEndListener(GMarkerEventManager manager, GMarker source)/*-{		
	 ...
	 */
	public static native void addOnDblClickListener(GMarkerEventManager manager, GMarker source)/*-{		
	    $wnd.GEvent.addListener(source, "dblclick", 
			function()
			{
	 ...
	 */
	public static native void addOnMouseDownListener(GMarkerEventManager manager, GMarker source)/*-{		
	    $wnd.GEvent.addListener(source, "mousedown", 
			function()
			{
	 ...
	 */
	public static native void addOnMouseUpListener(GMarkerEventManager manager, GMarker source)/*-{		
	    $wnd.GEvent.addListener(source, "mouseup", 
			function()
			{
	 ...
	 */
	public static native void addOnMouseOverListener(GMarkerEventManager manager, GMarker source)/*-{		
	 ...
	 */
	public static native void addOnMouseOutListener(GMarkerEventManager manager, GMarker source)/*-{		
	 ...
	 */
	public static native void addOnInfoWindowOpenListener(GMarkerEventManager manager, GMarker source)/*-{		
	 ...
	 */
	public static native void addOnInfoWindowCloseListener(GMarkerEventManager manager, GMarker source)/*-{		
	 ...
	 */
	public static native void addOnRemoveListener(GMarkerEventManager manager, GMarker source)/*-{		
	    $wnd.GEvent.addListener(source, "remove", 
			function()
			{
