				...
				function(response) {
				  ...
				  else
				  {
				    ...
				    for (myIndex=0; myIndex< response.Placemark.length; myIndex++) 
				    {
						...
						var state, county, city, streetLine, zip;
					    ...
					    temp = @com.mapitz.gwt.googleMaps.client.GGeocodeAddress::create(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;DD)(address0, streetLine, city, state, zip, county, country, lat, lng);				
